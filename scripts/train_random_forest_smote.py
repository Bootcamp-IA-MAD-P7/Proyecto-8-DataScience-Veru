"""Entrenamiento Random Forest + SMOTE — para comparativa.

Permite reproducir las métricas de Random Forest con SMOTE que se usan en la
...
def main():
    ...
    print(f"\n=== RANDOM FOREST + SMOTE (umbral {THRESHOLD}) ===")
    ...
    joblib.dump(pipe, MODEL_DIR / "random_forest_smote.pkl")
    print(f"\nModelo guardado en: {MODEL_DIR / 'random_forest_smote.pkl'}")
